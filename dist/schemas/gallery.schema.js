...
let Gallery = exports.Gallery = class Gallery extends mongoose_2.Document {
};
__decorate([
    (0, mongoose_1.Prop)({ default: '', required: false }),
    __metadata("design:type", String)
], Gallery.prototype, "_id", void 0);
__decorate([
    (0, mongoose_1.Prop)({ default: '', required: false }),
    __metadata("design:type", String)
], Gallery.prototype, "eventID", void 0);
__decorate([
    (0, mongoose_1.Prop)({ default: [], required: true }),
    __metadata("design:type", Array)
], Gallery.prototype, "mediaUrl", void 0);
exports.Gallery = Gallery = __decorate([
    (0, mongoose_1.Schema)()
], Gallery);
exports.GallerySchema = mongoose_1.SchemaFactory.createForClass(Gallery);
exports.GallerySchema.set('timestamps', true);
exports.GallerySchema.set('toJSON', {
    virtuals: true,
    versionKey: false,
